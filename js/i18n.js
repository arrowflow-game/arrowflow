...
const I18N = (() => {
  const STRINGS = {
    th: {
      ...
      'tutorial.combo.text': 'แตะเส้นทางสีเดียวกันติดต่อกันเพื่อรับคอมโบ จุดสีบนป้ายนี้บอกว่ากำลังต่อสีไหนอยู่ ยิ่งคอมโบยาว ยิ่งได้คะแนนโบนัสเยอะ',
    ...
    en: {
      ...
      'tutorial.combo.text': 'Tap same-colored paths back to back to build a combo. The dot on this badge shows which color you are chaining. Longer combos earn a bigger score bonus.',
