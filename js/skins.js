...
const Skins = (() => {
  const ALL = [
    ...
    { id: 'emerald',  unlock: { type: 'level', value: 25 },  altUnlock: { type: 'gems', value: 100 }, name: { th: 'มรกต',            en: 'Emerald' },
    ...
    { id: 'rose',     unlock: { type: 'level', value: 175 }, altUnlock: { type: 'gems', value: 700 }, name: { th: 'กุหลาบ',           en: 'Rose' },
    ...
    { id: 'cyber',    unlock: { type: 'level', value: 200 }, altUnlock: { type: 'gems', value: 800 }, name: { th: 'ไซเบอร์',          en: 'Cyber' },
    ...
    { id: 'obsidian', unlock: { type: 'level', value: 225 }, altUnlock: { type: 'gems', value: 900 }, name: { th: 'ออบซิเดียน',       en: 'Obsidian' },
    ...
    { id: 'aurora',   unlock: { type: 'level', value: 250 }, altUnlock: { type: 'gems', value: 1000 }, name: { th: 'ออโรรา',           en: 'Aurora' },
    ...
    { id: 'celestial',unlock: { type: 'level', value: 275 }, altUnlock: { type: 'gems', value: 1100 }, name: { th: 'จักรวาล',          en: 'Celestial' },
      colors: { face: { light: '#fdf6e3', dark: '#0a0820' } , path: { light: '#a8842f', dark: '#ffd77a' } },
      material: 'neon', arrowShape: 'star', particleTheme: 'sparks' },
    { id: 'legendary',unlock: { type: 'level', value: 300 }, altUnlock: { type: 'gems', value: 1200 }, name: { th: 'ตำนาน',            en: 'Legendary' },
